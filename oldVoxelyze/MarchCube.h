...
public:
	...
	static void SingleMaterial(CMesh* pMeshOut, CArray3D<float>* pArray, float Thresh = 0.0f, float Scale = 1.0f);
	
	static void SingleMaterialMultiColor(CMesh* pMeshOut, CArray3D<float>* pArray, CArray3D<float>* rColorArray, CArray3D<float>* gColorArray, CArray3D<float>* bColorArray, float Thresh = 0.0f, float Scale = 1.0f);
